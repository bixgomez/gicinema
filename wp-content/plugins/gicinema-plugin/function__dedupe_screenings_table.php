...
function function__dedupe_screenings_table() {
  ...
  if ($rows_affected !== false) {
      ...
      if ($rows_affected > 0) {
          echo "Success! " . $rows_affected . " duplicate rows were deleted.";
      } else {
          echo "No duplicate rows found to delete.";
      }
  } else {
      // If $wpdb->query() returned false, there was an error in the query
      echo "There was an error in attempting to delete duplicate rows.";
  }
