...
// Delete "this week" page if it exists
/*
function gicinema_shows_importer_page_deleter() {
    $page_title = 'This week at the Cinema';
...
register_activation_hook(__FILE__, 'gicinema_shows_importer_page_deleter');
*/

// Create page on plugin activation
function gicinema_shows_importer_page_creator() {
    $page_title = 'This week at the Cinema';
    $post_name = 'this-week';
    if (get_page_by_path($post_name) == NULL) {
        $contents = array(
            'post_title' => $page_title,
            'post_content' => 'This is the page I made',
            'post_name' => $post_name,
            'post_status' => 'publish',
            'post_type' => 'page'
        );
        $insert_page = wp_insert_post($contents);
    }
}
