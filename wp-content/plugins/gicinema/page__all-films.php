...
function gicinema_page_add__all_films() {
  ...
  add_submenu_page(
      ...
      'gicinema--all-films', // The slug name to refer to this submenu by (should be unique for this submenu)
      'gicinema_page_display__all_films' // The function to be called to output the content for this page
  );
}
add_action('admin_menu', 'gicinema_page_add__all_films');
